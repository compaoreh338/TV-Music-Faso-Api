...
public static class EnumDisplay
{
    public static string ToDisplayName(this Enum value) => value switch
    {
        ...
        ClipLanguage.Bissa => "Bissa",
        ClipLanguage.Gourmanche => "Gourmanchéma",
        ClipLanguage.Bwamu => "Bwamu",
        ClipLanguage.Dagara => "Dagara",
        ClipLanguage.Lobi => "Lobi",
        ClipLanguage.Lyele => "Lyélé",
        ClipLanguage.Nuni => "Nuni",
        ClipLanguage.Senoufo => "Sénoufo",
        ClipLanguage.San => "San",
        ClipLanguage.Kassena => "Kasséna",
        ClipLanguage.Bobo => "Bobo",
        ClipLanguage.Marka => "Marka",
        ClipLanguage.Tamasheq => "Tamasheq",
        ClipLanguage.Birifor => "Birifor",
        ClipLanguage.Cerma => "Cerma",
        ClipLanguage.Koromfe => "Koromfé",
        ClipLanguage.Siamou => "Siamou",
        ClipLanguage.Turka => "Turka",
        ClipLanguage.Winye => "Winye",
        ClipLanguage.Dogose => "Dogosé",
        ClipLanguage.Ninkare => "Ninkaré",
        ClipLanguage.Hausa => "Haoussa",
        ...
        ClipValidationStatus.Pending => "À valider",
        ClipValidationStatus.Validated => "Validé",
        ClipValidationStatus.Rejected => "Refusé",
